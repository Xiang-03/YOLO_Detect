...
# 2. 读取数据集配置
with open(r"E:\ultralytics-main\ultralytics\cfg\datasets\magni.yaml", "r", encoding="utf-8") as f:
    data_cfg = yaml.safe_load(f)

# 3. 读取 YOLO 官方完整超参数配置（路径要根据你本地 ultralytics 安装位置调整）
with open(r"E:\ultralytics-main\ultralytics\cfg\default.yaml", "r", encoding="utf-8") as f:
